        ...
        >
          {({ values }) => (
            <Form className="flex flex-col gap-6 rounded-xl border-[0.5px] bg-white p-8">
              ...
              <div id="_checkbox" className="flex  gap-2 items-baseline">
              <Field type="checkbox" name="sameAsInvestor" checked={values.sameAsInvestor} />
                <p>Nominee’s address is same as investor’s address</p>
              </div>
              {
               !values.sameAsInvestor &&   <div id="_bottomAddress" className="flex flex-col gap-6">
               <OptionHeading
              ...
              <div id="_button" className="grid grid-cols-2 gap-4">
                <Button
                  label="Save & Add More"
                  type="submit"
                  className="medium-text w-fit h-fit py-[10px] px-[11.5px] whitespace-nowrap max-h-12 rounded-md border border-[#55D976] text-base leading-7 tracking-[-0.3] text-[#21B546] md:block"
                />
                <div id="_empty"></div>
              </div>
            </Form>
      ...
      <div id="_button" className="flex items-center gap-5">
        ...
        <Button
          ...
          className={`medium-text max-h-12  text-base leading-7 tracking-[-0.3]  ${
            totalShare === 100 ? "bg-[#21B546] text-white" : " active:scale-[1] bg-[#F0F3F9] text-[#AFBACA]"
          }`}
