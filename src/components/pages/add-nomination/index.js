...
const AddNomination = () => {
  ...
  return (
    <>
      ...
      {/* {checkingStatus && (
        <div className=" fixed inset-0 z-[99] flex items-center justify-center overflow-y-auto overflow-x-hidden bg-[#5d5e5e] bg-opacity-[0.97] outline-none focus:outline-none">
          

          <h3 className="font-bold">{checkingStatus}</h3>
        </div>
      )} */}
