...
const InvestDetails = () => {
  ...
  const { apiResponse, error } = useSelector((state) => state?.investDetails);
  console.log("data is here", apiResponse, error);
        ...
        !apiResponse ? (
          ...
          <>
            <div
              ...
              style={{
                background: `linear-gradient(to left, ${apiResponse?.fd_end_colour}, ${apiResponse?.fd_start_colour})`,
              }}
            />
            <div
              id="_parent"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Image
                        ...
                        src={apiResponse?.logo_url ? apiResponse?.logo_url : ""}
                        alt="bank logo"
                  ...
                  >
                    <div id="_lefts" className="">
                      ...
                      <h5 className="bold-text whitespace-nowrap text-4xl leading-[44px] tracking-[-1] text-[#21B546]">
                        {apiResponse?.rate_of_interest?.toFixed(2)} %{" "}
                  ...
                  <div id="avatar" className="flex items-center gap-2 px-8">
                    <TextDisplay
                      ...
                      text={`Invested by ${apiResponse?.total_investors ? apiResponse?.total_investors : ""} investors `}
                      elementType="p"
                    />
                  ...
                  >
                    ...
                    <TextSmallLight
                      ...
                      text={
                        apiResponse?.fd_heading ? apiResponse?.fd_heading : ""
                      }
                ...
                <TenureSelection fdid={apiResponse?.fd_id} />
                <SafetyTrustInfo />
                <FDsComparison />
                <InvestmentBenefits />
                <FDActionSection />
