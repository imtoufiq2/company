...
// // const Card = () => {
// //   return (
// //     <div className="min-h-[116px]  min-w-[92px] md:min-w-[110px] lg:min-w-[140px] lg:min-h-[176px]  flex flex-col gap-1 lg:gap-3 w-full">
// //       <div
// //         id="image"
...
// //       >
// //         <img src="/images/HighReturn.svg" alt="" />
// //       </div>
// //       <div
// //         id="content"
...
// const Card = ({details}) => {
//   return (
//     <div className="flex-1 min-h-[116px] min-w-[92px] md:min-w-[110px] lg:min-w-[140px] lg:min-h-[176px] flex flex-col gap-1 lg:gap-3 w-full max-w-[140px]">
//       <div
//         id="image"
//         className="bg-white border-[0.5px] min-h-[92px] rounded-xl flex justify-center items-center md:h-[109px] md:min-w-[110px] lg:min-w-[140px] flex-1"
//       >
