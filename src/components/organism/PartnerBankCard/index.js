...
const PartnerBankCard = ({ curBank }) => {
  ...
  return (
    <div className={`flex w-full min-w-[84px] max-w-[84px]  flex-col gap-2 md:min-w-[100px] md:max-w-[100px] md:gap-5 ${Number(curBank?.is_comingsoon)!==1 && "cursor-pointer"}`} onClick={()=>{
      ...
      >
       {
        Number(curBank?.is_comingsoon)===1 &&  <p className="absolute right-2/4 top-0 translate-x-[50%]  whitespace-nowrap rounded-sm bg-[#cb6921] px-1 pb-[1px] text-[8px] text-white">
        coming soon
      </p>
       }
