...
const NomineeModal = ({
  ...
  const firstModalData = (
    <div className="relative top-4 flex h-full w-full max-w-[384px] flex-col rounded-lg  border-0 bg-white p-5 shadow-lg outline-none focus:outline-none md:max-w-[23.75rem] lg:h-auto">
