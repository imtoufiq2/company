    ...
    <div id="mainParent" className=" lg:mt-10 lg:mb-[100px] max-h-[742px] sm:max-h-[712px] md:max-h-[805px] lg:h-[450px] ">
      ...
      >
        <div id="leftParent" className=" bg-[#C2F2CE] pb-[143px] lg:w-[60%] lg:max-h-[428px]">
          <div
            id="left"
            className="w-[90%] lg:w-full  flex flex-col gap-4    m-auto  pt-3 lg:pt5    h-fit md:scale-90 lg:scale-100"
          >
            <div id="first" className="flex justify-between items-center ">
              ...
              <img
                className="w-10 h-10 rounded-full object-cover border-2 border-[#21B546] lg:hidden"
            ...
            <div id="third " className="flex flex-col gap-3 ">
              <div id="thirtop" className="flex items-center gap-2">
                ...
                />
                <p className="text-sm font-medium leading-6   md:text-lg lg:leading-[30px]  md:tracking-[-0.3]">
              ...
              >
                {
                  heroData.map((curData , index)=> {
                    return  <ImageCard key={index} data={curData}/>
                  })
                }
        ...
        <div
          id="right"
          //
          className="  w-[90%] p-5 sm:pt-0 sm:py-6 lg:p-7  mx-auto -translate-y-[27%] min-h-[350px] bg-white rounded-2xl border-[0.5px] max-w-[320px]   py-0  lg:w-[40%] lg:translate-y-[22%]  lg:pb-0 lg:h-[428px]"
          // lg:h-fit lg:translate-y-[52%] 772:translate-y-[52%] 913:translate-y-[38%] 990:translate-y-[25%]
        >
          <div
            id="bankLogo"
            // -translate-y-1/2
            className="w-[60px] h-[60px]  m-auto  rounded-full flex justify-center items-center  bg-white lg:w-[80px] lg:h-[80px] border border-[#D4FC79] -translate-y-1/2 sm:-translate-y-[50%] lg:-translate-y-[81%]"
          >
            <img
          ...
          <div className="flex flex-col gap-5 sm:gap-5 lg:gap-6 justify-between  pt-0 -translate-y-[5px]  lg:translate-y-[-10%]">
            <div
              id="badget"
