...
//   ];
//   return (
//     <div id="parent" className="sm:bg-[#C2F2CE] mb-[100px]">
//       <div
//         className=" relative  md:max-w-[75%]   mx-auto flex flex-col items-center sm:flex-row  max-w-[1008px] h-[670px] sm:h-[397px] md:h-fit sm:min-h-fit sm:py-5 justify-between   sm:p-0 sm:items-start sm:gap-0
//     "
//       >
//         <div
//           id="left"
//           className=" flex flex-col gap-4  mx-auto   w-full sm:w-full min-h-[430px] sm:min-h-[270px]     bg-[#C2F2CE]  sm:h-fit "
//         >
//           <div
//             id="first"
...
//           <h2
//             id="second"
//             className="w-[90%] mx-auto font-bold text-[20px] md:text-5xl leading-8 tracking-[-0.3] text-[#1B1B1B]  md:font-semibold md:leading-[60px]  md:tracking-[-0.1]  "
//           >
...
//             </span>
//           </h2>
//           <div id="third " className="flex flex-col gap-3 w-[90%] mx-auto">
...
//           id="right"
//           //
//           className="w-[90%] mx-auto min-h-[350px] bg-white rounded-2xl border-[0.5px]    p-3    -translate-y-[30%] sm:translate-y-[20%] md:translate-y-[41%] 777:translate-y-[41%] 780:translate-y-[40%] 913:translate-y-[27%]  927:translate-y-[27%] 990:translate-y-[17%] 1005:translate-y-[20%]  lg:translate-y-[17%] "
//         >
//           <div
//             id="bankLogo"
//             // -translate-y-1/2
...
//             />
//           </div>
//           <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 justify-between p-5 pt-0">
//             <div
//               id="badget"
...
const Index = () => {
  ...
  return (
    <div id="parent" className="sm:bg-[#C2F2CE] mb-[100px]">
      <div
        className=" relative w-[90%] md:w-[75%]   mx-auto flex flex-col items-center sm:flex-row  max-w-[1008px] h-[670px] sm:h-[397px] md:h-fit sm:min-h-fit sm:py-5 justify-between   sm:p-0 sm:items-start sm:gap-3
    "
      >
        <div
          id="left"
          className=" flex flex-col gap-4  mx-auto   w-full sm:w-full min-h-[430px] sm:min-h-[270px]    sm:min-w-[60%] bg-[#C2F2CE] sm:h-fit"
        >
        ...
        <div
          id="right"
          //
          className="min-h-[330px] bg-white rounded-2xl border-[0.5px]  sm:min-w-[40%]     w-full  h-fit    -translate-y-[30%] sm:translate-y-[20%] md:translate-y-[41%] 777:translate-y-[41%] 780:translate-y-[40%] 913:translate-y-[27%]  927:translate-y-[27%] 990:translate-y-[17%] 1005:translate-y-[20%]  lg:translate-y-[17%] "
        >
          <div
            id="bankLogo"
            // -translate-y-1/2
