...
const VideoCard = () => {
  return (
    <div className="w-full min-h-[215px] bg-[#FFF9DF] rounded-xl flex flex-col justify-between gap-[6px]">
      <div  className="min-h-[170px] bg-gray-300 rounded-xl"><VideoPlayerWithControls/></div>
