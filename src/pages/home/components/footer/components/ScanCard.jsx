    ...
    <div className=' p-8 flex flex-col gap-8 rounded-2xl bg-[#15362B]/50 flex-1 justify-between bg-opacity-[5%]' style={{background:"#214036"}}>
        <div id="top" className='flex items-center justify-between   gap-8'>
            ...
            <div id="right" className='flex flex-col gap-2'>
                <h3 className='font-bold text-[20px] leading-8 tracking-[-0.3]'>Invest on the go with our mobile app</h3>
                <div className='flex gap-4'><img src="/images/apple.svg" alt="apple store" className=''/>
                <img src="/images/google-playstore.svg" alt="playstore" />
                </div>
            </div>
        </div>
        <div id="bottom" className='font-normal text-[16px] leading-7 tracking-[-0.3] opacity-70'>Scan this QR code to download Altcase app</div>
    </div>
  )
}
